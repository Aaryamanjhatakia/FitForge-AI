...
//            log.info("PARSED RESPONSE FROM AI: {} ", jsonContent);
    ...
    private Recommendation createDefaultRecommendation(Activity activity) {
            return Recommendation.builder()
                    ...
                    .improvements(Collections.singletonList("Continue with your current activity and review manually"))
                    .suggestions(Collections.singletonList("Consider consulting a supervisor for further guidance"))
    ...
    private String createPromptForActivity(Activity activity) {
        return String.format("""
                ...
                Ensure that the response follows the EXACT JSON format shown above.
                """,
                        activity.getType(),
